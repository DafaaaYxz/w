...
const AdminPanel: React.FC<AdminPanelProps> = ({ 
    onNavigate, config, setConfig, testimonials, setTestimonials 
}) => {
  ...
  // Initial Fetch of users when entering Users tab
  useEffect(() => {
    if (activeTab === 'USERS') {
        loadUsers();
    }
                     ...
                     <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                             <div className="p-4 border border-gray-600 bg-black/40">
                                ...
                                <button 
                                    onClick={() => setConfig({...config, featureVoice: !config.featureVoice})}
                            ...
                            <div className="p-4 border border-gray-600 bg-black/40">
                                ...
                                <button 
                                    onClick={() => setConfig({...config, featureImage: !config.featureImage})}
  ...
  return (
    <div className="flex-1 container mx-auto p-4 md:p-6 mb-10">
        <div className="flex items-center justify-between mb-6 bg-black/80 p-4 border-b border-central-accent">
            ...
            <button onClick={() => onNavigate(Screen.HOME)} className="text-gray-400 hover:text-white font-mono text-xs border border-gray-600 px-3 py-1 hover:bg-gray-800">[LOGOUT]</button>
        </div>
